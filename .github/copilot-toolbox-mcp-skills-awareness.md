...
_Generated: 2026-09-21T15:58:09.489Z_
...
Workspace `mcp.json` _(folder: AI_Voice_Authenticity_Detection)_

- **d:\AI_Voice_Authenticity_Detection\.vscode\mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\vyshn\AppData\Roaming\Code\User\mcp.json** — _File missing_
